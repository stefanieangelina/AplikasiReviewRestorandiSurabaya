  ...
  <main id="main">
    ...
    <div class="container">
      <form method="post" class="form-group">
        ...
        <type="text" name="username" class="form-control"></type> <br/>
        <center> Password : </center>
        <type="text" name="password" class="form-control"></type> <br/>
        <center> Confirm Password : </center>
        <type="text" name="confirmPassword" class="form-control"></type> <br/>
      </form>
    </div>
